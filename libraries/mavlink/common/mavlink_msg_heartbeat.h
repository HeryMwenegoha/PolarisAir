...
typedef struct __mavlink_heartbeat_t
{
 ...
 uint8_t  base_mode; ///< System mode bitfield, see MAV_MODE ENUM in mavlink/include/mavlink_types.h
 ...
 * @param base_mode System mode bitfield, see MAV_MODE ENUM in mavlink/include/mavlink_types.h
